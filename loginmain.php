...
<head>
    ...
    <!-- REGISTERFORM -->        
        ...
        <h3>REGISTER-FORM</h3>
        <input type="text" placeholder="First name" name="fname" requipink/>   
        <input type="text" placeholder="Last name" name="lname" requipink/>
        ...
        <input type="text" name="mobile" placeholder="Enter Mob no" maxlength="12" requipink/>
        <label for="start">DATE OF BIRTH</label>
        <input type="date" value="DD/MM/YYYY" name="dob" requipink />
        <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Email (username)"> 

             
              <input type="text" name="addr1" placeholder="Address Line 1" maxlength="50" requipink/>
             <input type="text" name="addr2" placeholder="Address Line 2" maxlength="50" requipink/>
             <input type="text" name="city" placeholder="City" maxlength="15" requipink/>
             <input type="text" name="state" placeholder="State" maxlength="15" requipink/>
             <input type="number" name="pincode" placeholder="Pin Code" max="999999" requipink/>
 
        
            <input id="field_pwd1" title="Password must contain at least 6 characters, including UPPER/lowercase and numbers." type="password" requipink pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd1" placeholder="Enter Password">

             <input id="field_pwd2" title="Please enter the same Password as above." type="password" requipink pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd2" placeholder="Confirm password">
        ...
        <form class="login-form" method="POST" action="#">
            <h3>LOGIN</h3>
            <input type="text" placeholder="username" name="username" requipink/>
