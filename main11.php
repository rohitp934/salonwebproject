  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <div class="w3-center"><br>
        ...
        <img src="img/icopink2.png" alt="Avatar" style="width:20%" class="w3-circle w3-margin-top">
      </div>
            ...
            <div class="card-image">
              <img src="img/salon.jpg" alt="" height="310em">
                <span class="card-title"><h3>Salon</h3></span>
                 <a class="btn-floating halfway-fab waves-effect waves-light pink pulse" href="northindia.html"><i class="material-icons">add</i></a>
            </div>
